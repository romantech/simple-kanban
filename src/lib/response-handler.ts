...
import { type UnkeyStatusCode, unkeyStatusCodeMap } from '@/lib/unkey';
...
export const handleUnkeyError = (code: UnkeyStatusCode, resetIn?: string) => {
  const { status, message } = unkeyStatusCodeMap[code];
