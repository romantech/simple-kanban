...
export const editTaskSchema = taskSchema.pick({ title: true, description: true });
export const addTaskSchema = editTaskSchema.extend({
...
export const subtaskRequestSchema = taskSchema.pick({ title: true, description: true });
