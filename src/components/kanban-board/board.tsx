...
const Board = () => {
  ...
  return (
    <div className="scroll-custom flex w-full gap-4 overflow-x-auto px-6 py-5">
      ...
      <div className="mt-11 ml-auto flex">
        <ColumnAddDialog>
          <Button className="hidden h-full w-[210px] items-center justify-center gap-2 rounded-md bg-transparent bg-linear-to-b from-baltic-900/40 to-baltic-950 to-100% text-xl font-bold text-baltic-400 capitalize shadow-none transition-all hover:bg-baltic-900/40 active:scale-95 lg:flex [&_svg]:size-5">
            <Grid2x2Plus />
            컬럼 추가
          </Button>
        </ColumnAddDialog>
